...
class Day06Test {
    ...
    companion object {
        ...
        fun data() = cases(
            arrayOf(
                Arguments.of("year2022/Day06_sample1", 7, 19),
                Arguments.of("year2022/Day06_sample2", 5, 23),
                Arguments.of("year2022/Day06_sample3", 6, 23),
                Arguments.of("year2022/Day06_sample4", 10, 29),
                Arguments.of("year2022/Day06_sample5", 11, 26)
            ),
            Arguments.of("year2022/Day06_personal", 1140, 3495)
        )
    }
